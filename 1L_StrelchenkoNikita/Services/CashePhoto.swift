...
class CachePhoto: Operation {
    ...
    private lazy var filePath: String? = {
       ...
       // print(cachesDirectory.appendingPathComponent(CachePhoto.pathName + "/" + hasheName).path)
        return cachesDirectory.appendingPathComponent(CachePhoto.pathName + "/" + hasheName).path
